...
public class MapAdapterTester {
    ...
    public void testHashCode(){
        ...
        Object key = new String("AAA").hashCode();
        Object value = new Object();
        ...
        Object key2 = new String("BBB").hashCode();
        Object value2 = new Object();
        ma.put(key2,value2);
    ...
    public void testEquals(){
        ...
        assertTrue("Controllo che le mappe vuote siano uguali", ma.equals(ma2));
        ...
        assertTrue("Controllo che le mappe con lo stesso elemento all'interno siano uguali", ma.equals(ma2));

        Object tp = new Object();
        ma2.put(tp.hashCode(),tp);
        assertFalse("Controllo che le mappe con elementi diversi al loro interno NON siano uguali",ma.equals(ma2));
    ...
    public void TestConsistencyEqualsHashCode(){
        MapAdapter ma2 = new MapAdapter();
        assertTrue("Se entrambi sono vuoti allora sono uguali", (ma.equals(ma2) && ma.hashCode() == ma2.hashCode()));
        ...
        assertTrue("Se entrambi hanno gli stessi elementi allora sono uguali", (ma.equals(ma2) && ma.hashCode() == ma2.hashCode()));
        ...
        assertFalse("Controllo non siano uguali",ma.equals(ma2));
        assertNotEquals("Controllo non abbiano il medesimo hashcode",ma.hashCode(), ma2.hashCode());
    }
