...
public abstract class ListTester extends CollectionTester {
    ...
    public void test_AddAllIndex(){
        ...
        assertEquals("Checking size",initSize+given.size(),la.size());
    ...
    public void check_RemoveIndex_ioobe(){
        ...
        assertThrows("Removing position > size()",IndexOutOfBoundsException.class, () -> la.remove(itt.size()+1));
    }
    ...
    public void test_set(){
        ...
        assertEquals("Checking size is not changed",initSize,la.size());
    ...
    public void check_set_npe(){
        HList la = (HList) itt;
        la.add(new Object());
        assertThrows("Setting position with null",NullPointerException.class, () -> la.set(0,null));
    }
    ...
    public void check_set_ioobe(){
        ...
        assertThrows("Setting position > size()",IndexOutOfBoundsException.class, () -> la.set(la.size()+1,new Object()));
    }
